    ...
    $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
        {
            ...
            cache: false,
            dataType: "json",
            data: {f: "READ", n: "Arniyazov_Atabay_Test_project"},
            ...
            $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
                {
                    ...
                    cache: false,
                    dataType: "json",
                    data: {f: "INSERT", n: "Arniyazov_Atabay_Test_project", v: JSON.stringify(self.hashStorage)},
        ...
        $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
            {
                ...
                cache: false,
                dataType: "json",
                data: {f: "LOCKGET", n: "Arniyazov_Atabay_Test_project", p: password},
            ...
            $.ajax("http://fe.it-academy.by/AjaxStringStorage2.php",
                {
                    ...
                    cache: false,
                    dataType: "json",
                    data: {f: "UPDATE", n: "Arniyazov_Atabay_Test_project", p: password, v: JSON.stringify(hash)},
